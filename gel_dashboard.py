...
st.text("Hello and welcome to the GEL PCB Analytical Dashboard!")
...
radar1 = px.line_polar(water,
                         ...
                         line_close = True,
                         title = "Mean Of PCB Concentrations in Water")
...
radar2 = px.line_polar(water,
                         r = np.mean(soil[["AR 1260", "AR 1254", "AR 1242", "AR 1248"]]),
                         theta = ["AR 1260", "AR 1254", "AR 1242", "AR 1248"],
                         line_close = True,
                         title = "Mean Of PCB Concentrations in Soil")
...
radar3 = px.line_polar(water,
                         r = np.mean(oil[["AR 1260", "AR 1254", "AR 1242", "AR 1248"]]),
                         theta = ["AR 1260", "AR 1254", "AR 1242", "AR 1248"],
                         line_close = True,
                         title = "Mean Of PCB Concentrations in Oil")
